...
class MainActivity : AppCompatActivity() {
    ...
    //1. Define a data model class as a data source. DONE
    //2. Add the Recycle view to the layout. DONE
    //3. Create a custom raw layout XML file to visualize the item. DONE
    //4. Create an Adapter and ViewHolder to render the item. DONE
    //5. Bind the adapter to the data source to populate the RecycleView. DONE
